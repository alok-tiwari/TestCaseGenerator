...
async def debug_complete():
    ...
    try:
        ...
        llm_response = await generator._generate_with_llm(request, "functional_test")
        ...
        # Test Gherkin detection
        has_gherkin = "Scenario:" in llm_response or "Given" in llm_response or "When" in llm_response or "Then" in llm_response
        print(f"Has Gherkin keywords: {has_gherkin}")
        
        # Test parsing directly
        test_cases = generator._parse_llm_response(llm_response, request)
